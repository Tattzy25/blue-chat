...
export const PromptInputSpeechButton = ({
  ...
  useEffect(() => {
    ...
    // Set recognition state after effect completes
    const currentRecognition = recognitionRef.current;
    if (currentRecognition && !recognition) {
      const timeoutId = setTimeout(() => setRecognition(currentRecognition), 0);
      return () => {
  ...
  }, [textareaRef, onTranscriptionChange, recognition]);
